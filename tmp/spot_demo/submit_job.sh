...
arena submit etjob  --loglevel=debug \
    ...
    python /mnt/example/imagenet/pytorch_imagenet_resnet50_elastic.py  --epochs=100 --num-workers=6 --train-dir=/mnt/data/imageNet/ILSVRC/Data/CLS-LOC-MINI/train --val-dir=/mnt/data/imageNet/ILSVRC/Data/CLS-LOC-MINI/val --checkpoint-format=./"$jobname"-checkpoint-{epoch}.pth.tar --name="$jobname